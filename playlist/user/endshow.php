<?php
// $Id: endshow.php,v 1.6 2004/08/31 15:20:38 admin Exp $
/******************************************************************************
...
$userID = fetchUserID();
$pl_session = new PlaylistSession($_GET[show_id], $userID, $link);
...
if (isset($form[reject]))	{
	header( "Location: currplaylistframes.php?show_id=$_GET[show_id]" );
}
